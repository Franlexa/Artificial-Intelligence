...
public class BestFirstProblem implements Problem {
    ...
    HeuristicState finalState = new HeuristicState(HeuristicState.H);
    ...
    public double getStepCost(Object start, Object action, Object dest) {
        if (((HeuristicState) start).value.equals("A")) {
            if (action.equals("go to B"))
                return 2;
            if (action.equals("go to C"))
                return 1;
        }
        if (((HeuristicState) start).value.equals("B")) {
            if (action.equals("go to D"))
                return 1;
            if (action.equals("go to E"))
                return 3;
        }
        if (((HeuristicState) start).value.equals("C")) {
            if (action.equals("go to D"))
                return 3;
        }
        if (((HeuristicState) start).value.equals("E")) {
            if (action.equals("go to F"))
                return 2;
        }
        if (((HeuristicState) start).value.equals("C")) {
            if (action.equals("go to D"))
        ...
        if (((HeuristicState) start).value.equals("D")) {
            if (action.equals("go to G"))
                return 5;
        }
        if (((HeuristicState) start).value.equals("C")) {
            if (action.equals("go to D"))
        ...
        if (((HeuristicState) start).value.equals("F")) {
            if (action.equals("go to H"))
                return 1;
        }
        if (((HeuristicState) start).value.equals("G")) {
            if (action.equals("go to H"))
                return 3;
        }
