...
public class UniformCostProblem implements Problem {
    ...
    public double getStepCost(Object start, Object action, Object dest) {
        if (((SimpleState) start).value.equals("A")) {
            if (action.equals("go to B"))
                return 2;
            if (action.equals("go to C"))
                return 1;
        }
        if (((SimpleState) start).value.equals("B")) {
            if (action.equals("go to D"))
                return 1;
            if (action.equals("go to E"))
                return 3;
        }
        if (((SimpleState) start).value.equals("C")) {
            if (action.equals("go to D"))
                return 3;
        }
        if (((SimpleState) start).value.equals("E")) {
        ...
        if (((SimpleState) start).value.equals("D")) {
        ...
        if (((SimpleState) start).value.equals("F")) {
            if (action.equals("go to H"))
                return 1;
        }
        if (((SimpleState) start).value.equals("G")) {
            if (action.equals("go to H"))
                return 3;
        }
